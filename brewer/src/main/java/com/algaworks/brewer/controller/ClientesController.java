...
public class ClientesController {
	...
	public ModelAndView salvar(@Valid Cliente cliente, BindingResult result, Model model, RedirectAttributes attributes) {
		...
		try{
			...
			//REJEITAR VALOR ATRAVES DE REGRA DE NEGÓCIO, AO INVÉS DE BEAN~ VALIDATION
	...
	public ModelAndView pesquisar(ClienteFilter clienteFilter, BindingResult result, 
			@PageableDefault(size=2) Pageable pageable, HttpServletRequest httpServletRequest){ // Pageable ativa quando acrescenta @EnableSpringDataWebSupport no WebConfig.java.
	...
	//Metodo GET para funcionar com JSON
