...
//Tratado em ControllerAdviceExceptionHandler		
	...
	@GetMapping()
	public ModelAndView pesquisar(EstiloFilter estilo_filter, BindingResult result, 
		...
		PageWrapper<Estilo> paginaWrapper = new PageWrapper<>(estilos.filtrar(estilo_filter, pageable), httpServletRequest);
